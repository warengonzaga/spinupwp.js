# SpinupWPJS (Unofficial) [![huntr](https://cdn.huntr.dev/huntr_security_badge_mono.svg)](https://huntr.dev)
...
A simple and lightweight but powerful NodeJS client for **[SpinupWP](http://spinupwp.com)** API.
